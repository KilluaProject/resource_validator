...
export default function ResultModal({ data, onClose }: ResultModalProps) {
  ...
  // 1. Ambil ASN dari string IRR Object
  ...
  // 2. Tentukan Max Length (Hostmaster Best Practice)
  const getMaxLength = (cidr: string) => {
    if (cidr.includes(":")) return "48"; // IPv6 -> /48
    return "24"; // IPv4 -> Selalu saranin /24
  };

  // 3. Fungsi Copy to Clipboard (Biar makin enak)
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="pl-4 border-l-2 border-slate-200 space-y-1">
                       ...
                       {item.children === "-" ? (
                        <p className="text-sm text-slate-400 italic">No sub-allocations</p>
                      ) : (
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div className="bg-slate-50 p-3 rounded-lg border border-slate-100">
                         ...
                         <p className="text-sm font-bold text-slate-700 font-mono truncate" title={item.rpki_detail}>{item.rpki_detail}</p>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      {/* PENTING: whitespace-pre-wrap biar enter dari python kebaca */}
                      <div className="bg-slate-800 text-slate-200 p-3 rounded-lg font-mono text-[11px] shadow-inner whitespace-pre-wrap leading-relaxed max-h-32 overflow-y-auto">
                        {item.ptr_record}
                      </div>
                    </div>
