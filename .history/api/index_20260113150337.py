...
# ==========================================
# 2. WORKER TASKS (LOGIC UTAMA)
# ==========================================

# --- TASK A: APNIC HIERARCHY (FIXED: FILTER IDNIC DIHAPUS) ---
def task_apnic_hierarchy(cidr):
    ...
    for obj in hierarchy_list:
        ...
        # source = obj.get('source', '').upper() # <-- KITA NONAKTIFKAN CEK SOURCE BIAR DATA GAK HILANG
...
# --- TASK B: ROUTING INTELLIGENCE (FIXED: SAFETY CHECKS) ---
    ...
    try:
        with requests.Session() as s:
            ...
            if roas:
                ...
                # Fix tampilan /None kalau maxlen kosong
...
# --- TASK C: REVERSE DNS (FIXED: ERROR HANDLING) ---
