...
# --- TASK A: APNIC HIERARCHY (FIXED: SOURCE APNIC ONLY & PORTABLE CHECK) ---
def task_apnic_hierarchy(cidr):
    ...
    for obj in hierarchy_list:
        ...
        source = obj.get('source', '').upper() # Ambil field source

        # === FILTER BARU: BUANG SOURCE IDNIC ===
        # Sesuai request: Cuma percaya data dari 'source: APNIC'
        if 'IDNIC' in source: 
            continue 
    ...
    # 3. Portable Check (Logic sebelumnya tetep dipake buat safety)
