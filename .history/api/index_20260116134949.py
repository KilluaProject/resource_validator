...
# === TASKS (HIERARCHY FIXED: NO PARENT DUPLICATE IN CHILD) ===
def task_apnic_hierarchy(cidr):
    ...
    # Sort Priority: Size Besar > Source APNIC
    def sort_priority(x):
    ...
    if len(unique_hierarchy) > 1:
        for obj in unique_hierarchy[1:]:
            ...
            # Kalau Range object ini SAMA dengan Range Parent, SKIP!
            # Ini biar Parent versi IDNIC gak muncul di list Sub-allocation.
