...
# ==========================================
# 5. API ENDPOINT (DOUBLE DECORATOR FIX)
# ==========================================
...
# Kita pasang 2 alamat pintu masuk biar Vercel seneng, Localhost juga seneng.

@app.post("/api/scan")  # <--- Jalur Vercel
@app.post("/scan")      # <--- Jalur Localhost
