...
# --- TASK A: APNIC HIERARCHY (UNIVERSAL PARENT FIX) ---
def task_apnic_hierarchy(cidr):
    ...
    for obj in hierarchy_list:
        ...
        # === FILTER LOGIC BARU (UNIVERSAL) ===
        if rng in seen: continue
        
        # HAPUS Hardcode 103.0.0.0
        # Cukup filter by NAME: 'APNIC-AP' atau 'IANA'
        # Ini berlaku buat 103, 202, 27, 114, dll.
        if name == 'APNIC-AP' or name == 'IANA':
            continue
