...
# ==========================================
# 2. MODUL REVERSE DOMAIN & DELEGATION (BALIK LAGI)
# ==========================================
...
def scan_ip_logic(cidr_str):
    ...
    if "No DNS" not in dns_ptr: final_ptr = f"{dns_ptr} (Live)"
    elif "No Whois" not in whois_ns: final_ptr = f"{whois_ns} (Whois)"
    else: final_ptr = "No Reverse DNS"
...
# ==========================================
# 5. API ENDPOINT (SUPPORT LOCAL & VERCEL)
# ==========================================
...
@app.post("/api/scan")
@app.post("/scan") # Ini biar localhost bisa akses
