      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <section className="relative overflow-hidden bg-slate-900 rounded-3xl p-8 md:p-12 text-center shadow-2xl animate-in zoom-in-95 duration-700 delay-200">
           ...
           <div className="relative z-10 flex flex-col items-center">
              <div className="w-20 h-20 bg-linear-to-b from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-2xl font-bold text-white shadow-lg mb-6 border-4 border-slate-800">
                RA 
              </div>
              ...
              <blockquote className="max-w-xl mx-auto text-slate-400 text-sm italic leading-relaxed mb-8">
                &quot;Tools ini lahir bukan karena skill koding yang jago, tapi murni karena pengen mempermudah kerjaan aja.&quot;
              </blockquote>
